...
(function(window, document, undefined) {
	...
	var _Scrolleo = function(opts) {
	  // Defaults
	  this.acceleration = 0.05; //1 is fastest, 0 is slowest, 0.08 is default
		...
		Array.prototype.forEach.call(this.wrapper, function(wr) {
		  ...
		  var getElemDistanceToTop = function(elem) {
			...
			scrollControl = function() {
			  ...
			  self.currentTime = (document.documentElement.scrollHeight - window.innerHeight - self.scrollPos) / self.pixelsPerSecond; //convert scrollPos from pixels to seconds to set self.currentTime
